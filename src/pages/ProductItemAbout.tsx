      ...
      <div className={styles.comments__section}>
        {data?.map((user) => (
          <div>
            ...
            <div>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugit ex vero nihil ab minus, fuga, porro illum quis eum cumque suscipit quidem nemo sit magnam, beatae veritatis exercitationem at. Velit.</div>
          </div>
        ))}
      </div>
    </div>
